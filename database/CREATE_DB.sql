...
CREATE TABLE IF NOT EXISTS `technohouse`.`Notification` (
  ...
  `Answer_idAnswer` INT NULL,
  `Question_idQuestion` INT NULL,
  ...
  INDEX `fk_Notification_Answer1_idx` (`Answer_idAnswer` ASC) ,
  INDEX `fk_Notification_Question1_idx` (`Question_idQuestion` ASC) ,
  ...
  CONSTRAINT `fk_Notification_User1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Notification_Answer1`
    FOREIGN KEY (`Answer_idAnswer`)
    REFERENCES `technohouse`.`Answer` (`idAnswer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Notification_Question1`
    FOREIGN KEY (`Question_idQuestion`)
    REFERENCES `technohouse`.`Question` (`idQuestion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
